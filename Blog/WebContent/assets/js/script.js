...
$(window).scroll(function() {
  ...
  if (
    $("html").scrollTop() > $("#navigation-wrapper nav").height() ||
    $("body").scrollTop() > $("#navigation-wrapper nav").height()
  ) {
...
$(function() {
  if (navigator.userAgent.match(/MicroMessenger/i)) {
    ...
    wechat_img = wechat_img
      ...
      .replace(/[\'\"]?\).*/, "");
    $("body").prepend(
      '<div style="overflow: hidden; width: 0; height: 0; margin: 0 auto;"><img src="' +
        wechat_img +
        '" /></div>'
    );
  }
